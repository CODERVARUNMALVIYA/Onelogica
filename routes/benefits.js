...
router.get("/BenefitsList", async (req, res) => {
    try {
...
router.post("/CreateBenefit", async (req, res) => {
...
router.post("/EnrollBenefit", async (req, res) => {
...
router.post("/RecordBenefitUsage", async (req, res) => {
